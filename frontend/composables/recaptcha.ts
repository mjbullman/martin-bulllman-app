...
/**
 * The exported executeRecaptcha function allows you to execute reCAPTCHA actions and retrieve the reCAPTCHA
 * token along with the header options to be used in subsequent requests.
 */
export default () => {
